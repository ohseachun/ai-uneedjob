...
// 로컬 모듈 import
import { keywordExtractionPrompt } from "./project-prompts";  // 키워드 추출용 프롬프트
import { fetchProjectText } from "./utils";  // 웹 스크래핑 유틸리티
...
async function summarizeProject() {
  // 1단계: 웹 스크래핑으로 프로젝트 텍스트 수집
  const rawText = await fetchProjectText();
...
// 테스트 실행
// const projectUrl = "https://www.bbc.com/news/technology-66208730";
// const projectUrl = "http://localhost:8080/admin/joboffer/one_line_project_view.do?seq=6511";
